...
import com.example.a181013_tiarafajrianiachmar_a.model.Mahasiswa;
...
public class inputBiodata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDaftar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                int yourGender = rjk.getCheckedRadioButtonId();
                ...
                database.close();
                displayToast("Tiara fajriani-181013_A : Success menambahkan data mahasiswa");
        ...
        btnShow.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(inputBiodata.this,ViewData.class);
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                database.close();
                displayToast("TiaraFajriani-181013_A : Data Berhasil Di Update!!!!");
            }
        });
        btnDaftar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                displayToast("TiaraFajriani-181013_A : Success menambahkan data mahasiswa");
            }
        });
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mahasiswa != null){
                    displayToast("TiaraFajriani-181013_A : Data Telah Terdaftar!!");
                    ...
                    displayToast("TiaraFajriani-181013_A : Data Kosong!!");
                }
                database.close();
        ...
        btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (result){
                    displayToast("TiaraFajriani-181013_A : Data berhasil Dihapus!!");
                    txtStb.setText("");
                    txtNama.setText("");
                    rb_P.setChecked(false);
                    rb_L.setChecked(false);
                    ...
                    displayToast("TiaraFajriani-181013_A : Data Tidak Bisa Dihapus!!!");
                }
                database.close();
            }
        });
    ...
    private void showAlert() {
        androidx.appcompat.app.AlertDialog alertDialog = new androidx.appcompat.app.AlertDialog.Builder(inputBiodata.this).create();
        ...
        alertDialog.setButton(androidx.appcompat.app.AlertDialog.BUTTON_POSITIVE, "ALLOW", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                ActivityCompat.requestPermissions(inputBiodata.this, new String[]{Manifest.permission.CAMERA}, MY_PERMISSIONS_REQUEST_CAMERA);
            }
        }); alertDialog.show();
        ...
        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "SETTINGS", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) { dialog.dismiss();
                startInstalledAppDetailsActivity(inputBiodata.this);
            }
        });
        alertDialog.show();
    }
                ...
                for (int i = 0, len = permissions.length; i < len; i++) {
                    ...
                    if (grantResults[i] == PackageManager.PERMISSION_DENIED) {
                        ...
                        if (showRationale) {
                            ...
                            saveToPreferences(inputBiodata.this, ALLOW_KEY, true);
                        }
                    }
                }
            }
    ...
    public static void startInstalledAppDetailsActivity(final inputBiodata context) {
        if (context == null) {
            return;
        }
